...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const allRoles = employeeDetails('rolesDetail');
    let employeesData = []
    ...
    for (let i = 0; i < view.length; i++) {
        view[i].addEventListener('click',editEmployeeForm);
        
    }
    //    view.addEventListener('click',editEmployeeForm);
    ...
    employeeBlock.innerHTML = `
                    ...
                    <div class="employee-info-container flex-column">
                        <div class="employee-info flex">
                            <div><img src="/images/id.svg" alt=""></div>
                            <div> ${employee.empNo}</div>
                        </div>
                        <div class="employee-info flex">
                            <div><img src="/images/email-1_svgrepo.com.svg" alt=""></div>
